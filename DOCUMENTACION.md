...
* [métodos del API](#métodos-del-api)
    * [crear pago](#crear-pago-paydata-credit_card)
    * [continuar pago](#continuar-pago-resumedata-money_with_wings)
    * [cancelar pago](#cancelar-pago-canceldata-x)
    * [ver pago](#ver-pago-viewdata-mag)
